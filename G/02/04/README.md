...
Error
```
03_homework03.c:6:13: error: use of undeclared identifier 'a'
scanf("%d",&a);}while(a<0||a>9);
            ^
03_homework03.c:6:23: error: use of undeclared identifier 'a'
scanf("%d",&a);}while(a<0||a>9);
                      ^
03_homework03.c:6:28: error: use of undeclared identifier 'a'
scanf("%d",&a);}while(a<0||a>9);
                           ^
3 errors generated.
